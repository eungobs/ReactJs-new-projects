...
Four-Day Weather Predictions: Displays weather forecasts for the next four days, including temperature and weather conditions.

Location-Based Forecasting
Set Location Manually: Users can enter any city or location in South Africa to get weather information.
...
Day/Night Mode: The app automatically switches between a light theme (day mode) and a dark theme (night mode) based on the current time.
...
Usage
Search for a Location: Use the search bar to enter any city or location in South Africa and get weather information.
