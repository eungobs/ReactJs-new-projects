  ...
  return (
    <Container>
      <Box my={4}>
        ...
        <Typography paragraph>
          To exercise your rights or if you have any questions about our data practices, please contact us at{' '}
          <Link href="mailto:eungobs@gmail.com">eungobs@gmail.com</Link>.
        </Typography>
